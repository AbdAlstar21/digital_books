...
class BooksEva extends StatefulWidget {
  @override
  _BooksEvaState createState() => _BooksEvaState();
}

class _BooksEvaState extends State<BooksEva> {
  ...
  void getDataBook(int count, String strSearch) async {
    loadingList = true;
    setState(() {});
    List arr = await getData(count, "evas/readeva_book.php", strSearch,
